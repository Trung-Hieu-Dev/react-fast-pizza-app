      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {formErrors?.phone &&
              <p className="mt-2 p-2 rounded-full text-xs text-red-500 bg-red-100">{formErrors?.phone}</p>}
          </div>
        </div>
        ...
        <div className="mb-12 flex items-center gap-5">
          <input type="checkbox" name="priority" id="priority" className="h-6 w-6 accent-yellow-400 focus:ring
